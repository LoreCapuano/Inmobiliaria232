 ...
 * @author mgandolfo
 */
public class mensajeAdvertenciaOLD extends javax.swing.JDialog {
    
    TituloMensajes ms = new TituloMensajes();
    

    public mensajeAdvertenciaOLD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mensajeAdvertenciaOLD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                mensajeAdvertenciaOLD dialog = new mensajeAdvertenciaOLD(new javax.swing.JFrame(), true);
